...
- Средняя стоимость (15-25 руб/км): 40% рейсов
- Высокая стоимость (>25 руб/км): 0%
### Самые экономичные рейсы
| trip_id | vehicle_id | distance_km | cost_per_km |
|---------|------------|-------------|-------------|
| 1 | F606 | 3376 | 68.80 |
| 7611 | G707 | 288 | 68.90 |
| 6656 | C303 | 109 | 71.10 |

### Самые затратные рейсы
| trip_id | vehicle_id | distance_km | cost_per_km |
|---------|------------|-------------|-------------|
| 4962 | D404 | 209 | 73.60 |
| 1318 | E505 | 145 | 73.30 |
...
### Ключевые выводы
- Большие расстояния снижают удельную стоимость (эффект масштаба)
- Электромобиль G707 показывает вариативность результатов в зависимости от маршрута
- Дополнительные расходы существенно влияют на стоимость коротких рейсов
- Наиболее эффективен F606 для дальних маршрутов
