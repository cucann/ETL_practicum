...
## Вывод
Разработанный ETL-пайплайн позволяет прогнозировать продажи на основе температуры воздуха. Модель линейной регрессии показывает, что при увеличении температуры на 1 градус продажи растут на 4.94 единицы. Прогноз при 15°C составил 175.84, что на 9.88 выше прогноза при 13°C. Это позволяет бизнесу адаптировать логистику и управление запасами в зависимости от погодных условий.  

Развернута среда Airflow в Docker, спроектирована трехуровневая архитектура (Source, Storage, Business). Реализован DAG variant_09_athens_weather с 7 задачами для извлечения, трансформации и загрузки данных. Получены данные погоды для Афин за 14 дней, выполнено округление температуры. Обучена модель линейной регрессии, экспортирована в ml_model.pkl. В Jupyter Notebook выполнен прогноз продаж, построен интерактивный график.  


[Файл ml_model.pkl](ml_model.pkl)  
[Файл прогноз_продаж.ipynb](https://colab.research.google.com/drive/1J6zJRvRiZcX2UYFegS2UmWO9zZMLSy-n?usp=sharing)  
